...
namespace DataPlanning.Data.Migrations
{
    ...
    [Migration("20180605192439_item-group-status")]
    partial class itemgroupstatus
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataPlanning.Data.ItemGroupStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("DataPlanning.Data.ItemGroupStatus", b =>
                {
                    b.HasOne("DataPlanning.Data.ItemGroup", "ItemGroup")
                        .WithOne("ItemGroupStatus")
                        .HasForeignKey("DataPlanning.Data.ItemGroupStatus", "ItemGroupId")
                        .OnDelete(DeleteBehavior.Restrict);
                });
